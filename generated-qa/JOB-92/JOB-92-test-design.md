# JOB-92 - QA Test Design

## Summary

ResumeProfile rebuild/backfill and stale-profile correction
...
2. Import JOB-92-testrail-cases.csv into TestRail if the cases look useful.
3. Keep or edit JOB-92-fixtures.json.
4. Promote JOB-92-fixture-test.spec.js into the main tests folder only after review.
