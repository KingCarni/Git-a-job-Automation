# JOB-125 - QA Test Design

## Summary

Cover Letter Templates — harden preview, print, and export parity for curated layout set
...
2. Import JOB-125-testrail-cases.csv into TestRail if the cases look useful.
3. Keep or edit JOB-125-fixtures.json.
4. Promote JOB-125-fixture-test.spec.js into the main tests folder only after review.
