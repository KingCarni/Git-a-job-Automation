# JOB-95 - QA Test Design

## Summary

Calibrate keyword fit score against selected ResumeProfile strength
...
2. Import JOB-95-testrail-cases.csv into TestRail if the cases look useful.
3. Keep or edit JOB-95-fixtures.json.
4. Promote JOB-95-fixture-test.spec.js into the main tests folder only after review.
